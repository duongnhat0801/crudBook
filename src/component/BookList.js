...
function BookList() {
    ...
    useEffect(() => {
        getAllBookList(title);
    }, [title]);

    const getAllBookList = async (title) => {
        let res = await bookService.getAllBookList(title);
        setBooks(res);
        console.log(res);
    ...
    return (
        <div className="container">
            ...
            <div>
                <input value={title}  placeholder={"Tìm kiếm theo tên"}  onChange={(e) => setTitle(e.target.value)}/>
            </div>
